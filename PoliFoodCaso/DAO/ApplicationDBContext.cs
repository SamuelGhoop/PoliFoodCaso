...
namespace PoliFoodCaso.DAO
{
    ...
    new IdentityRole { Id = studentRoleId, Name = "Student", NormalizedName = "STUDENT", ConcurrencyStamp = studentRoleId }
            ...
            builder.Entity<Producto>().HasData(
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6001-4000-8000-000000000011"), nombre_producto = "Clásica", descripcion = "Carne 150g, lechuga, tomate, queso", precio = 12500, imagen_url = "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=300", disponible = true, existencias = 50, minutos_preparacion = 10, isActive = 1, categoriaId = Guid.Parse(cat1Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6002-4000-8000-000000000012"), nombre_producto = "Doble Cheddar", descripcion = "Doble carne, doble queso cheddar", precio = 16500, imagen_url = "https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=300", disponible = true, existencias = 50, minutos_preparacion = 12, isActive = 1, categoriaId = Guid.Parse(cat1Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6003-4000-8000-000000000013"), nombre_producto = "Pollo Crispy", descripcion = "Pechuga apanada, mayonesa especial", precio = 14000, imagen_url = "https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=300", disponible = true, existencias = 50, minutos_preparacion = 14, isActive = 1, categoriaId = Guid.Parse(cat1Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6004-4000-8000-000000000014"), nombre_producto = "Veggie", descripcion = "Hamburguesa de garbanzo vegana", precio = 13000, imagen_url = "https://images.unsplash.com/photo-1520072959219-c595dc870360?w=300", disponible = true, existencias = 50, minutos_preparacion = 10, isActive = 1, categoriaId = Guid.Parse(cat1Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6005-4000-8000-000000000015"), nombre_producto = "Gaseosa", descripcion = "350ml fría", precio = 3500, imagen_url = "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=300", disponible = true, existencias = 50, minutos_preparacion = 1, isActive = 1, categoriaId = Guid.Parse(cat2Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6006-4000-8000-000000000016"), nombre_producto = "Limonada", descripcion = "Limón, agua, azúcar, hielo", precio = 4500, imagen_url = "https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=300", disponible = true, existencias = 50, minutos_preparacion = 3, isActive = 1, categoriaId = Guid.Parse(cat2Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6007-4000-8000-000000000017"), nombre_producto = "Margarita", descripcion = "Salsa, mozzarella y albahaca", precio = 18000, imagen_url = "https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=300", disponible = true, existencias = 50, minutos_preparacion = 15, isActive = 1, categoriaId = Guid.Parse(cat3Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6008-4000-8000-000000000018"), nombre_producto = "Pepperoni", descripcion = "Salsa, pepperoni y mozzarella", precio = 22000, imagen_url = "https://images.unsplash.com/photo-1628840042765-356cda07504e?w=300", disponible = true, existencias = 50, minutos_preparacion = 18, isActive = 1, categoriaId = Guid.Parse(cat3Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6009-4000-8000-000000000019"), nombre_producto = "4 Quesos", descripcion = "Mozzarella, cheddar, azul, parm", precio = 25000, imagen_url = "https://images.unsplash.com/photo-1513104890138-7c749659a591?w=300", disponible = true, existencias = 50, minutos_preparacion = 20, isActive = 1, categoriaId = Guid.Parse(cat3Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6010-4000-8000-000000000020"), nombre_producto = "Hawaiana", descripcion = "Piña, jamón, mozzarella", precio = 21000, imagen_url = "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=300", disponible = false, existencias = 0, minutos_preparacion = 18, isActive = 1, categoriaId = Guid.Parse(cat3Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6011-4000-8000-000000000021"), nombre_producto = "Tiramisú", descripcion = "Porción individual artesanal", precio = 8000, imagen_url = "https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=300", disponible = true, existencias = 50, minutos_preparacion = 2, isActive = 1, categoriaId = Guid.Parse(cat4Id) },
                new Producto { id_producto = Guid.Parse("e1b2c3d4-6012-4000-8000-000000000022"), nombre_producto = "Brownie", descripcion = "Brownie de chocolate con helado", precio = 7000, imagen_url = "https://images.unsplash.com/photo-1606313564200-e75d5e30476c?w=300", disponible = true, existencias = 50, minutos_preparacion = 2, isActive = 1, categoriaId = Guid.Parse(cat4Id) }
            );
